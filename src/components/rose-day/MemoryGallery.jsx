...
const memories = [
  { id: 1, label: "The First Date", rotation: -4 },
  { id: 2, label: "Summer Walks", rotation: 3 },
  { id: 3, label: "Laughter & Coffee", rotation: -2 },
  { id: 4, label: "Our Magic Moment", rotation: 5 },
];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {memories.map((memory, i) => (
            ...
            >
              {/* The Polaroid Frame */}
              <div className="bg-white p-4 pb-12 shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-slate-100 rounded-sm">
