  ...
  return (
    <section className="py-24 px-6 flex justify-center items-center relative overflow-hidden">
      ...
      >
        ...
        <div className="bg-gradient-to-b from-white to-pink-100 backdrop-blur-xl border border-rose-300 p-12 md:p-20 rounded-[3rem] shadow-[0_30px_100px_rgba(251,113,133,0.12)] text-center relative overflow-hidden group">
