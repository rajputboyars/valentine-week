      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
        {roses.map((rose, i) => (
          ...
          >
            ...
            <div className="bg-white/60 backdrop-blur-md border border-rose-50 rounded-[3rem] p-10 text-center shadow-[0_15px_40px_rgba(0,0,0,0.02)] h-full flex flex-col items-center">
